package wyq.appengine2.datamodel;
 ...
 * implementation to
 * {@linkplain wyq.appengine2.datamodel.Table#loadData(TableDataSource)
 * loadData(TableDataSource)} method to start. See
 * {@link wyq.appengine2.toolbox.CsvFile.CsvTable} for example.
 * 
 * @author dewafer
 * @version 2
 */
